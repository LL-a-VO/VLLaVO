...
class Lens(nn.Module):
    def __init__(
        ...
        vocab_attributes: str = "dataset/descriptors-text-davinci-003",
        vocab_tags: str = "dataset/vocab_tags",
        ...
        if self.clip_name is not None:
            ...
            # Load Vocabularies
            self.vocab_tags = load_dataset(vocab_tags, split=split_tags, data_dir="data")[
                "prompt_descriptions"
            ]
            print(split_attributes)
            # self.vocab_attributes = flatten(
            #     load_dataset(vocab_attributes, split=split_attributes, data_dir="data")[
            #         "prompt_descriptions"
            #     ]
            # )
            self.vocab_attributes = flatten(
                load_dataset("parquet", data_files="dataset/descriptors-text-davinci-003/data/full-00000-of-00001-36595cef85e2dc0f.parquet")['train'][
                    "prompt_descriptions"
                ]
            )
